...
import 'package:pandit_ji/product_details/product_details_widget.dart';
...
class AppStateNotifier extends ChangeNotifier {
  PanditJiFirebaseUser? initialUser;
  PanditJiFirebaseUser? user;
  ...
  void update(PanditJiFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => BookingConfirmedWidget(),
            ),
            ...
            FFRoute(
              name: 'EcomCheckout',
              path: 'EcomCheckout',
              builder: (context, params) => EcomCheckoutWidget(),
            ),

            FFRoute(
              name: 'EcomList',
              path: 'EcomList',
              builder: (context, params) => EcomListWidget(),
            ),
